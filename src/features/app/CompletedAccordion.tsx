          ...
          {completedStops.map((s) => {
            ...
            return (
              <div key={s.id} className='p-4 border-b last:border-b-0' style={{ borderColor: 'var(--color-light-grey)' }}>
                <button
                  className='w-full text-left flex items-center justify-between hover:bg-gray-50 focus:bg-gray-50 focus:ring-2 focus:ring-opacity-50 focus:outline-none p-2 -m-2 rounded transition-colors'
